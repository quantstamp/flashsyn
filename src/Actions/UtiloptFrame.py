def f(paras, ActionWrapper, Action_list):
    ...
    for ii in range(len(Action_list)):
        ...
        if Action.numInputs == 0:
            Action.transit(paras[:para_index], Action_list[0:ii+1])
        elif Action.numInputs == 1:
            Action.transit(paras[:para_index+1], Action_list[0:ii+1])
            para_index += 1
        elif Action.numInputs == 2:
            Action.transit(paras[:para_index+2], Action_list[0:ii+1])
            para_index += 2
...
def f_display(paras, ActionWrapper, Action_list, isSim = False):
    ...
    for ii in range(len(Action_list)):
        ...
        if Action.numInputs == 0:
            if isSimulate:
                print(Action.simulate(paras[:para_index+1], Action_list[0:ii+1]))
            Action.transit(paras[:para_index], Action_list[0:ii+1])
        elif Action.numInputs == 1:
            if isSimulate:
                print(Action.simulate(paras[:para_index+1], Action_list[0:ii+1]))
            ...
            if isSimulate:
                print(Action.simulate(paras[:para_index+2], Action_list[0:ii+1]))
            Action.transit(paras[:para_index+2], Action_list[0:ii+1])
            para_index += 2
    if isSim:
...
def c(paras, ActionWrapper, Action_list):
    ...
    for Action in Action_list:
        if Action.numInputs == 0:
            ...
            Action.transit(paras[:para_index+1])
            para_index += 1
        elif Action.numInputs == 2:
            Action.transit(paras[:para_index+2])
            para_index += 2
        ...
        def c1(paras):
            ...
            for ii in range(len(Action_list)):
                ...
                if Action.numInputs == 0:
                    ...
                    Action.transit(paras[:para_index+2], paras[para_index + 1], Action_list[0:ii + 1])
                    para_index += 2
            minBalance = min(ActionWrapper.currentBalances.values())
            return minBalance
